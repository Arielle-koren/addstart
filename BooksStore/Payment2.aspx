                        ...
                        <div class="card-body">
                            ...
                            <form class="form" role="form" autocomplete="off">
                                <div class="form-group">
                                   ...
                                   <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="לא תקין" ControlToValidate="TextBox1" ValidationExpression="^[אבגדהוזחטיכלמנסעפצקרשתץףןםך]+(?:\s[אבגדהוזחטיכלמנסעפצקרשתץףןםך]+)+$|^((\b[a-zA-Z]{2,40}\b)\s*){2,}$" BackColor="WhiteSmoke"></asp:RegularExpressionValidator>
                                </div>
                                <div class="form-group">
