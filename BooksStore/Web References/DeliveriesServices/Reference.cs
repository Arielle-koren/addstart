...
namespace BooksStore.DeliveriesServices {
    ...
    public partial class WebService1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void GetStatusAsync(int OrderID, int costumerID) {
            this.GetStatusAsync(OrderID, costumerID, null);
        }
        
        /// <remarks/>
        public void GetStatusAsync(int OrderID, int costumerID, object userState) {
            ...
            this.InvokeAsync("GetStatus", new object[] {
                        OrderID,
                        costumerID}, this.GetStatusOperationCompleted, userState);
        }
